 ...
 */
  ...
  loadingToast(callback?: () => void, description: string = '', title: string = '友情提示',
       options = {showConfirmButton: false, toast: false, position: "center" as SweetAlertPosition, timer: 500}): void {
    swal.fire({
      titleText: title,
      text: description,
      icon: 'info',
