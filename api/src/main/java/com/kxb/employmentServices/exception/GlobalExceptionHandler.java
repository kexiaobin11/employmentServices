...
public class GlobalExceptionHandler {
    ...
    public GlobalExceptionHandler() {
        ...
        this.exceptionStatusMap.put(AuthUserTypeNotSupportException.class, new ErrorMessage("the login user type is not support", HttpStatus.UNAUTHORIZED, 40101));
        ...
        this.exceptionStatusMap.put(NoResourceFoundException.class, new ErrorMessage("resource not found 404", HttpStatus.BAD_REQUEST, 40402));
        ...
        this.exceptionStatusMap.put(RuntimeException.class, new ErrorMessage("runtime exception", HttpStatus.SERVICE_UNAVAILABLE, 50001, e -> {
            e.printStackTrace();
            ArrayList<String> errors = new ArrayList<>();
        ...
        this.exceptionStatusMap.put(NullPointerException.class, new ErrorMessage("null pointer exception, plz contact us", HttpStatus.SERVICE_UNAVAILABLE, 50005, e -> {
            e.printStackTrace();
            ArrayList<String> errors = new ArrayList<>();
            errors.add(e.getMessage());
            return errors;
    ...
    public static class ErrorMessage {
        ...
        public ErrorMessage(String message, HttpStatus httpStatus, int status) {
            this(message, httpStatus, status, e -> (e.getMessage() == null || e.getMessage().isEmpty()) ? new ArrayList<>() : Collections.singletonList(e.getMessage()));
        }
